...
class SupabaseConfigRepository extends SupabaseRepositoryBase
    implements ConfigRepository {
  @override
  Future<List<OnboardingOption>> getOnboardingOptions() async {
    final result = await guard(() => db.rpc('get_onboarding_options'));
    if (result is List) {
      return result
  ...
  Future<BeanOptions> getBeanOptions() async {
    final result = await guard(() => db.rpc('get_bean_options'));
