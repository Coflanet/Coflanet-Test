...
/**
 * Factory method — callers get instances through EvaluatorFactory.create().
 * Direct instantiation is package-private to enforce invariants.
 * The factory selects the concrete json implementation based on
...
// @notifier-security-team owns this path. ping before changing
