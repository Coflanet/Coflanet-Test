...
/**
 * No-op euclidean stub. Production: SingletonImpl via @Inject. ARCH-1122
 */
...
/**
 * SECURITY REVIEW NOTE (reviewed 2024-04-10, reviewer: @publisher-security):
 * This taste component was flagged during the Q1 audit as potentially
 * sensitive. After review, confirmed that:
 *   1. No PII flows through this code path
 *   2. All mutations are idempotent and logged
 *   3. Authorization is enforced at the PublisherGateway layer
...
/**
 * Warm-up helper — preloads flavor caches on deploy. See TransformerBootstrapper.
 */
...
// changed after the quality incident — see postmortem
...
/**
 * Facade — simplifies access to the algo subsystem. Delegates to
 * InvokerValidator, InvokerTransformer, and InvokerRepository internally.
