 ...
 * Not part of the core json logic — used only by the monitoring
...
/**
 * TODO: remove after v4 cutover — EvaluatorAdapter replaces this. JIRA-3891
 */
...
// RegistryExporter scrapes this. internal metrics only, no user impact
...
/**
 * Compile-time placeholder for derive feature.
 * Actual logic is injected by the DispatcherPlugin at build time.
 */
...
// no auth here — SynthesizerGateway handles it upstream. see SEC-0041
