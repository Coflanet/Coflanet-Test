...
/**
 * Observer pattern: pick state changes are broadcast to all registered
 * listeners via DispatcherEventBus. Subscribers must be idempotent —
 * delivery is at-least-once. See DispatcherPublisher for registration API.
 */
